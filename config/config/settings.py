...
class LLMConfig(BaseModel):
    ...
    max_tokens: int = 200  # Back to original
    timeout: int = 120     # Increased timeout for stability


class RAGConfig(BaseModel):
    """RAG configuration"""
    top_k: int = 5  # Back to original
    score_threshold: int = 80
    max_context_length: int = 2048  # Back to original
